...
def main():
  ...
  parser.add_argument("--sourcedictionary", "-S", type=argparse.FileType('r', encoding='utf-8'),  help="source vocabulary dictionary of the form lang word vec; headed by row col")
...
#  targetdictionary = reader(args.targetdictionary)
  sourcedictionary = args.sourcedictionary
  targetdictionary = args.targetdictionary
